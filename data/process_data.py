...
Usage:
    ...
    python data/process_data.py                  # process all sprites
    python data/process_data.py --limit 5        # process first 5 sprites (for testing)
    python data/process_data.py --limit 20 --base_dir pokemon_sprites --data_dir data
"""
